	hft_top_system u0 (
		...
		.fifo_hps_to_fpga_out_endofpacket    (<connected-to-fifo_hps_to_fpga_out_endofpacket>),    //                      .endofpacket
		.fifo_hps_to_fpga_out_empty          (<connected-to-fifo_hps_to_fpga_out_empty>),          //                      .empty
		.fifo_hps_to_fpga_out_ready          (<connected-to-fifo_hps_to_fpga_out_ready>),          //                      .ready
		...
		.fifo_ouch_ingress_out_valid         (<connected-to-fifo_ouch_ingress_out_valid>),         // fifo_ouch_ingress_out.valid
		.fifo_ouch_ingress_out_data          (<connected-to-fifo_ouch_ingress_out_data>),          //                      .data
		.fifo_ouch_ingress_out_startofpacket (<connected-to-fifo_ouch_ingress_out_startofpacket>), //                      .startofpacket
		.fifo_ouch_ingress_out_endofpacket   (<connected-to-fifo_ouch_ingress_out_endofpacket>),   //                      .endofpacket
		.fifo_ouch_ingress_out_empty         (<connected-to-fifo_ouch_ingress_out_empty>),         //                      .empty
		.fifo_ouch_ingress_out_ready         (<connected-to-fifo_ouch_ingress_out_ready>)          //                      .ready
	);
