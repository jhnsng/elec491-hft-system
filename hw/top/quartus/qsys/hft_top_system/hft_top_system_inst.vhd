	component hft_top_system is
		port (
			...
			fifo_hps_to_fpga_out_endofpacket    : out   std_logic;                                        -- endofpacket
			fifo_hps_to_fpga_out_empty          : out   std_logic_vector(1 downto 0);                     -- empty
			fifo_hps_to_fpga_out_ready          : in    std_logic                     := 'X';             -- ready
			...
			fifo_ouch_ingress_out_valid         : out   std_logic;                                        -- valid
			fifo_ouch_ingress_out_data          : out   std_logic_vector(31 downto 0);                    -- data
			fifo_ouch_ingress_out_startofpacket : out   std_logic;                                        -- startofpacket
			fifo_ouch_ingress_out_endofpacket   : out   std_logic;                                        -- endofpacket
			fifo_ouch_ingress_out_empty         : out   std_logic_vector(1 downto 0);                     -- empty
			fifo_ouch_ingress_out_ready         : in    std_logic                     := 'X'              -- ready
		);
	...
	u0 : component hft_top_system
		port map (
			...
			fifo_hps_to_fpga_out_endofpacket    => CONNECTED_TO_fifo_hps_to_fpga_out_endofpacket,    --                      .endofpacket
			fifo_hps_to_fpga_out_empty          => CONNECTED_TO_fifo_hps_to_fpga_out_empty,          --                      .empty
			fifo_hps_to_fpga_out_ready          => CONNECTED_TO_fifo_hps_to_fpga_out_ready,          --                      .ready
			...
			fifo_ouch_ingress_out_valid         => CONNECTED_TO_fifo_ouch_ingress_out_valid,         -- fifo_ouch_ingress_out.valid
			fifo_ouch_ingress_out_data          => CONNECTED_TO_fifo_ouch_ingress_out_data,          --                      .data
			fifo_ouch_ingress_out_startofpacket => CONNECTED_TO_fifo_ouch_ingress_out_startofpacket, --                      .startofpacket
			fifo_ouch_ingress_out_endofpacket   => CONNECTED_TO_fifo_ouch_ingress_out_endofpacket,   --                      .endofpacket
			fifo_ouch_ingress_out_empty         => CONNECTED_TO_fifo_ouch_ingress_out_empty,         --                      .empty
			fifo_ouch_ingress_out_ready         => CONNECTED_TO_fifo_ouch_ingress_out_ready          --                      .ready
		);
