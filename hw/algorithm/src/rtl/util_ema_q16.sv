module util_ema_q16 #(
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      x_s1 <= '0; x_s2 <= '0; x_s3 <= '0; x_s4 <= '0; x_s5 <= '0; x_s6 <= '0;
      
      diff_s1 <= '0;
      abs_diff_s2 <= '0; sign_s2 <= 0;
      p0_s3 <= 0; p1_s3 <= 0; p2_s3 <= 0; p3_s3 <= 0; sign_s3 <= 0;
      sum01_s4 <= 0; sum23_s4 <= 0; sign_s4 <= 0;
      abs_prod_s5 <= 0; sign_s5 <= 0;
      prod_s6 <= '0;
    end else begin
      en_s1 <= en; first_s1 <= first_sample; x_s1 <= x_scaled;
      en_s2 <= en_s1; first_s2 <= first_s1; x_s2 <= x_s1;
      en_s3 <= en_s2; first_s3 <= first_s2; x_s3 <= x_s2;
      en_s4 <= en_s3; first_s4 <= first_s3; x_s4 <= x_s3;
      en_s5 <= en_s4; first_s5 <= first_s4; x_s5 <= x_s4;
      en_s6 <= en_s5; first_s6 <= first_s5; x_s6 <= x_s5;

      // STAGE 1: Subtraction
      if (en) begin
        diff_s1 <= x_scaled - y_accum;
        if (first_sample) first_sample <= 1'b0;
      end
