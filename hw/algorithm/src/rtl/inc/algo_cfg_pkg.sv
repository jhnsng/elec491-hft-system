package algo_cfg_pkg;
  ...
  // =========================================================================
  // CORRECTLY SCALED RISK & SPREAD KNOBS (1 cent = 100 units)
  // =========================================================================
  
  // Allow trading as long as the spread is $0.05 or less (500 units)
  localparam logic [31:0] MAX_SPREAD_TICKS = 32'd500;  
  
  localparam logic [31:0] DEFAULT_QTY      = 32'd100;

  // Require a true 2-cent momentum breakout (200 units) to beat the spread!
  localparam signed [63:0] CROSS_THRESHOLD = 64'd200; 
